var Mens_300x600_DressFurnLauren1015 = Project_Base.extend({
	  ///////////////////////////////////////////////////////////////////////////////////////
	  ///////////////////////////////////////////////////////////////////////////////////////
	  //private var
	  ///////////////////////////////////////////////////////////////////////////////////////
	  ...
	  //String
	  //---------------------------------------------------------
	  traceID:"Mens_300x600_DressFurnLauren1015",
	  ///////////////////////////////////////////////////////////////////////////////////////
	  ///////////////////////////////////////////////////////////////////////////////////////
	  //Constructor
	  ///////////////////////////////////////////////////////////////////////////////////////
	 ...
	 step_1:function() {
		...
		delay += .4;
		$elm = this.$div.find(".logo_1");
		TweenLite.to($elm, 1.5, {delay:delay, x:70, ease:Quad.easeOut});
		//-------------------------------------
		delay += 0;
	   ...
	   step_2:function() {
		...
		$elm = this.$div.find(".logo_1");
		TweenLite.set($elm, {opacity:1});
		TweenLite.to($elm, 2, {delay:delay, x:0, ease:Expo.easeOut});
		//--------------------------------------
		delay += .5;
		...
		$elm = this.$div.find(".txt_0");
		TweenLite.set($elm, {opacity:1});
		TweenLite.from($elm, 3, {delay:delay, opacity:0, ease:Quad.easeOut});
		//--------------------------------------
		delay += .4;
		$elm = this.$cta;
		TweenEngine.set(this.$div.find(".cta"), {opacity:1});
