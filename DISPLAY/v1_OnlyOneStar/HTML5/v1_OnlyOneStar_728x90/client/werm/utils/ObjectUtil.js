var ObjectUtil_cls = Class.extend({
	...
	//-------------------------------------------------------------------------------------
	getItem:function(_itemObj) {
		//---------------------------------------------------------
		//init var
		//---------------------------------------------------------
		var newItem = _itemObj;
		//---------------------------------------------------------
		if (GenFun.isJohnClass(_itemObj)) {
			newItem = new _itemObj();
		} else if (_itemObj.classID != undefined) {
			newItem = _itemObj;
		} else if(typeof(_itemObj) == "object") {
			if (_itemObj.classRef != undefined) {
				if(_itemObj.classRef.classID != undefined){
					newItem = _itemObj.classRef;
					SetPublicProp.go(newItem, _itemObj.prop);
				} else if(typeof(_itemObj.classRef) == "string") {
					newItem = (_itemObj.prop != undefined) ? new window[_itemObj.classRef]($.extend({},_itemObj.prop), false) : new window[_itemObj['classRef']]()
				} else {
					newItem = (_itemObj.prop != undefined) ? new _itemObj.classRef($.extend({},_itemObj.prop), false) : new _itemObj.classRef();
				}
			}
		}
		return newItem;
