var Mens_300x250_DressFurnLauren1015 = Project_Base.extend({
	  ///////////////////////////////////////////////////////////////////////////////////////
	  ///////////////////////////////////////////////////////////////////////////////////////
	  //private var
	  ///////////////////////////////////////////////////////////////////////////////////////
	  ...
	  //String
	  //---------------------------------------------------------
	  traceID:"Mens_300x250_DressFurnLauren1015",
	  ///////////////////////////////////////////////////////////////////////////////////////
	  ///////////////////////////////////////////////////////////////////////////////////////
	  //Constructor
	  ///////////////////////////////////////////////////////////////////////////////////////
	 ...
	 init:function(obj, init_preStart) {
	  ...
	  step_0:function() {
		...
		TweenLite.set($elm, {opacity:1});
		TweenLite.from($elm, 3, {delay:delay, opacity:0, scale:1.3,  ease:Expo.easeOut});
		//TweenLite.from($elm, 1, {delay:delay, y:"300", ease:Expo.easeInOut});
		//--------------------------------------
		delay += 0;
		$elm = this.$div.find(".oos_0");
		TweenLite.set($elm, {opacity:1});
		TweenLite.from($elm, 1.3, {delay:delay, opacity:0, x:40, ease:Back.easeOut});
		//--------------------------------------
		delay += .2;
